...
export default function Contact() {
    return (
        <section className="py-12 lg:py-20 px-4 lg:px-20 border-t border-gray-400">
            ...
            <div className="flex flex-col-reverse md:flex-row gap-20 justify-center">
                ...
                <div className="w-full md:w-1/2">
                    <h3 className="text-3xl font-bold uppercase tracking-wider">Location &amp; opening hours</h3>
